...
*/
const userWithLessThanTwoSkills = users.filter((lessSkills) => lessSkills.skills.length < 2)
console.log(userWithLessThanTwoSkills)
...
newStudentObj.skills.frontEnd.push({skill: "Bootsrap", level: 8})
newStudentObj.skills.backEnd.push({skills: "Express", level: 9})
newStudentObj.skills.dataBase.push({skills: "SQL", level: 8})
newStudentObj.skills.dataScience.push("SQL")
