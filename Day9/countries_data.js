...
*/
// Using map, sort and localeCompare
// Sort by name
const sortedByName = countriesData.map(c => c).sort((a, b) => a.name.localeCompare(b.name));
console.log(sortedByName)
// Sort by capital
const sortedByCapital = countriesData.map(c => c).sort((a, b) => a.capital.localeCompare(b.capital));
console.log(sortedByCapital)
// Sort by population
const sortedByPopulation = countriesData.map(c => c).sort((a, b) => b.population - a.population);
console.log(sortedByPopulation)

// using sort and localeCompare
// Sort by name
const sortedByName1 = countriesData.sort((a, b) => a.name.localeCompare(b.name));
console.log(sortedByName1)
// Sort by capital
const sortedByCapital1 = countriesData.sort((a, b) => a.capital.localeCompare(b.capital));
console.log(sortedByCapital1)
// Sort by population
const sortedByPopulation1 = countriesData.sort((a, b) => b.population - a.population);
console.log(sortedByPopulation1)
